...
* CSS - Grid layout, gradients, hover/active states, dynamic styling
* Git & GitHub - Version control, pushing to repositories
...
* Decimal point input, with duplicate-decimal prevention
* Backspace button to undo the last digit entered
* Full keyboard support (numbers, operators, Enter, Backspace, Escape)
* CE (Clear Entry) and AC (All Clear) buttons with distinct behavior
* GT (Grand Total) button that tracks a running sum across calculations
* Snarky, randomized error messages on divide-by-zero
